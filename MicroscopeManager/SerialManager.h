...
public:
	...
	virtual void CreateSerialDevice(std::string deviceName, std::string portName, int baudrate, std::vector<std::string> exitCommands);
	virtual void DeleteSerialDevice(std::string deviceName);
